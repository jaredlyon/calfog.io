...
def main():
    ...
    output_dir = Path("models/random forest")
    output_dir.mkdir(parents=True, exist_ok=True)
    output_file = output_dir / f"random_forest_results.txt"
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        for result in all_results:
            ...
            f.write(f"\n  Feature Importance (sorted by Gini importance, {len(without['feature_importance'])} features):\n")
            ...
            f.write(f"\n  Feature Importance (sorted by Gini importance, {len(with_aqi['feature_importance'])} features):\n")
            ...
            f.write(f"\n  Feature Importance (sorted by Gini importance, {len(without_reduced['feature_importance'])} features):\n")
